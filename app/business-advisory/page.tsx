    ...
    <main ref={containerRef} className="bg-[#0F172A] min-h-screen text-slate-200 selection:bg-[#C5A059] selection:text-white">
            ...
            <div className="lg:w-1/2 feature-split-right relative">
              <div className="relative rounded-2xl overflow-hidden border border-slate-700 shadow-2xl">
                <Image
                  ...
                  alt="Modern skyscrapers in Sandton urban landscape representing growth and structure"
                  width={800}
                  height={600}
      ...
      <section className="py-24 relative cta-section">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            src="https://images.pexels.com/photos/33622140/pexels-photo-33622140/free-photo-of-aerial-view-of-sandton-skyline-at-dusk.jpeg?auto=compress&cs=tinysrgb&w=1280"
            alt="Aerial view of Sandton skyline at dusk"
            fill
