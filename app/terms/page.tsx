  ...
  return (
    <main ref={containerRef} className="min-h-screen pt-24 pb-12 px-4 md:px-8 max-w-6xl mx-auto">
      ...
      <header className="grid md:grid-cols-2 gap-12 items-center mb-20">
        ...
        <div className="relative h-[300px] md:h-[400px] rounded-2xl overflow-hidden shadow-2xl shadow-black/50 border border-slate-700 terms-hero-image group bg-slate-800">
          <Image 
            src="https://images.unsplash.com/photo-1589829085413-56de8ae18c73?w=1200&auto=format&fit=crop&q=80"
